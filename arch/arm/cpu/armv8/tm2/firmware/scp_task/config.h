...
#define SECURE_TASK_RESPONSE_MEM_BASE   (CONFIG_RAM_END + 512)
#define HIGH_TASK_SHARE_MEM_BASE        (SECURE_TASK_SHARE_MEM_BASE + 1024)
#define HIGH_TASK_RESPONSE_MEM_BASE     (HIGH_TASK_SHARE_MEM_BASE + 512)
#define LOW_TASK_SHARE_MEM_BASE         (HIGH_TASK_SHARE_MEM_BASE + 1024)
#define LOW_TASK_RESPONSE_MEM_BASE      (LOW_TASK_SHARE_MEM_BASE + 512)
/*
