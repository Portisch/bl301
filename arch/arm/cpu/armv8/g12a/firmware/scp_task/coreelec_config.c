...
/*
 * arch/arm/cpu/armv8/g12a/firmware/scp_task/coreelec_config.c
 *
...
struct config_value_char14 cec_osd_name = {
	.config_id = HASH(config_cec_osd_name, cec_osd_name),
	.val = CONFIG_CEC_OSD_NAME
};

/* disable 5V system power (USB) by default set by inject_bl301 from config.ini */
struct config_value_uint enable_5V_system_power = {
	.config_id = HASH(config_enable_5V_system_power, usbpower),
	.val = 0
};
