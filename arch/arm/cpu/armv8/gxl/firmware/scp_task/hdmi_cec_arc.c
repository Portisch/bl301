...
void cec_report_device_power_status(int dst)
{
	unsigned char msg[3];
...
void cec_menu_status_smp(int menu_status, int dst)
{
	unsigned char msg[3];
...
void cec_give_deck_status(int dst)
{
	unsigned char msg[3];
